...
func (*parse_stream) ConsumeSimpleClass(text string, opts ...CallOptionFunc) (stream_types.SimpleClass, error) {
...
func (*parse_stream) MakeSimpleClass(text string, opts ...CallOptionFunc) (stream_types.SimpleClass, error) {
